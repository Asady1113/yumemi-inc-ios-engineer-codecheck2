...
public extension KRProgressHUD {
    /// Returns the appearance proxy for the receiver.
    ///
    /// - Returns: The appearance proxy for the receiver.
    static func appearance() -> KRProgressHUDAppearance {
    ...
    @discardableResult static func set(style: KRProgressHUDStyle) -> KRProgressHUD.Type {
        shared.style = style
    ...
    /// - Returns: KRProgressHUD.Type (discardable)
    @discardableResult static func set(maskType: KRProgressHUDMaskType) -> KRProgressHUD.Type {
    ...
    /// - Returns: KRProgressHUD.Type (discardable)
    @discardableResult static func set(activityIndicatorViewColors colors: [UIColor]) -> KRProgressHUD.Type {
    ...
    /// - Returns: KRProgressHUD.Type (discardable)
    @discardableResult static func set(font: UIFont) -> KRProgressHUD.Type {
        shared.font = font
        return KRProgressHUD.self
    }
    ...
    /// - Returns: KRProgressHUD.Type (discardable)
    @discardableResult static func set(viewOffset offset: CGFloat) -> KRProgressHUD.Type {
    ...
    /// - Returns: KRProgressHUD.Type (discardable)
    @discardableResult static func set(duration: Double) -> KRProgressHUD.Type {
        shared.duration = duration
        return KRProgressHUD.self
    }

    @discardableResult static func set(graceTime: Double) -> KRProgressHUD.Type {
    ...
    ///
    /// - Returns: KRProgressHUD.Type (discardable)
    @discardableResult static func resetStyles() -> KRProgressHUD.Type {
        shared.style = nil
        shared.maskType = nil
    ...
    static func showOn(_ viewController: UIViewController) -> KRProgressHUD.Type {
        shared.presentingViewController = viewController
        return KRProgressHUD.self
    }

    @available(*, deprecated, message: "Use set(activityIndicatorViewColors:)")
    @discardableResult static func set(activityIndicatorViewStyle style: KRActivityIndicatorViewStyle) -> KRProgressHUD.Type {
        shared.activityIndicatorColors = [style.headColor, style.tailColor]
        return KRProgressHUD.self
    }

    @available(*, renamed: "set(ducation:)")
    @discardableResult static func set(deadline time: Double) -> KRProgressHUD.Type {
...
public extension KRProgressHUD {
    ...
    static func show(withMessage message: String? = nil, completion: CompletionHandler? = nil) {
    ...
    static func showSuccess(withMessage message: String? = nil) {
    ...
    ///
    /// - Parameter message: HUD's message.
    static func showInfo(withMessage message: String? = nil) {
    ...
    ///
    /// - Parameter message: HUD's message.
    static func showWarning(withMessage message: String? = nil) {
    ...
    ///
    /// - Parameter message: HUD's message.
    static func showError(withMessage message: String? = nil) {
    ...
    ///   - size: Image size.
    ///   - message: HUD's message.
    static func showImage(_ image: UIImage, size: CGSize? = nil, message: String? = nil) {
    ...
    static func dismiss(_ completion: CompletionHandler? = nil) {
